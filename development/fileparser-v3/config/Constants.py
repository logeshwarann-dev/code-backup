filePath = r"static/Updated_10L_HistoryFile.csv"
...
startTimeStr = "01-10-2024 11:33:07"            #input of type "dd:mm:yyyy hh:mm:ss" 
endTimeStr = "01-10-2024 11:49:46"  
searchTraderId = "*" # 1001
searchPartitionId = "*" # 1 - 10
searchProductId = "*" # some int
factorOfTimeWarping = 1 
duration = 60 # 
TIME_WARPING_FACTOR = 2
TIME_WARPING = True
