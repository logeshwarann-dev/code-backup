...
func ReadConfig(filename string) error {
	...
	for scanner.Scan() {
		...
		logFlag, err11 := strconv.Atoi(entries[12])
		tradeFlag := entries[13]

		static.AssignSessionMap()

		if err0 != nil || err1 != nil || err2 != nil || err3 != nil || err4 != nil || err5 != nil || err6 != nil || err7 != nil || err8 != nil || err9 != nil || err10 != nil || err11 != nil {
		...
		configs.LogFlag = logFlag
		configs.TradeFlag = tradeFlag
		...
		if strings.Contains(configs.TradeFlag, "trade") {
			static.TRADE = true
		}

		if configs.LogFlag == 1 {
