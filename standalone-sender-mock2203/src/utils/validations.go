...
func ValidateOPSRate(data static.OPSRate) error {
...
func UpdateRecordsValidationCheck(record static.Record) error {
...
func DeleteRecordsValidationCheck(record static.DeleteOrd) error {
	if record.InstrumentID <= 0 {
...
func ValidateDelayDetails(data static.DelayDetails) error {
	if data.Min < 1 {
