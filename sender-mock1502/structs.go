...
type Config struct {
	...
	ModifyPercent          int      `json:"modify_percent" binding:"required"`
	CancelPercent          int      `json:"cancel_percent" binding:"required"`
	...
	UniqueClientIdentifier bool     `json:"unique_client_identifier"`
